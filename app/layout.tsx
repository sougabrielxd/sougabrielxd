...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: "Gabriel Lucas | Desenvolvedor Full-Stack",
    description: "Desenvolvedor Full-Stack especializado em React, Next.js e automação",
    images: [`${baseUrl}/img/og-image.png`],
  ...
  return (
    <html lang="pt">
      <head>
        ...
        <meta property="og:image" content={`${baseUrl}/img/og-image.png`} />
        <meta property="og:image:secure_url" content={`${baseUrl}/img/og-image.png`} />
        ...
        <meta name="twitter:image" content={`${baseUrl}/img/og-image.png`} />
