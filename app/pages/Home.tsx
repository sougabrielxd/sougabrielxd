      ...
      description:
        language === "pt"
          ? [
              ...
              "Atuo na criação de sites responsivos, interfaces e experiências de usuário (UI/UX) que equilibram usabilidade e estética.",
              "Entre os principais resultados, destaco o aumento de mais de 222 mil visualizações e 4,2 mil interações em um único mês em perfis gerenciados.",
            ]
          : [
              "I provide customized digital design and development services, tailored to the needs and objectives of each client.",
              "I work on creating responsive websites, user interfaces (UI/UX) that balance usability and aesthetics.",
              "Among the main results, I highlight the increase of over 222,000 views and 4,200 interactions in a single month on managed profiles.",
            ],
      skills:
        language === "pt"
          ? [
    ...
    <div className="relative min-h-screen bg-background text-foreground">
          ...
          {showLanguageMenu && (
            <div className="absolute right-0 mt-2 w-32 rounded-lg border border-black/60 dark:border-red-500/50 bg-background shadow-lg shadow-black/40 dark:shadow-red-500/20 z-50 overflow-hidden transition-all duration-300">
              <button
                ...
                className="w-full px-4 py-2 text-left border-t border-black/20 dark:border-red-500/20 hover:bg-black/10 dark:hover:bg-red-500/10 transition-colors flex items-center gap-2"
              >
                <span className="text-sm font-semibold">Português</span>
                {language === "pt" && (
                  <span className="ml-auto text-black dark:text-red-500">
                    ✓
                  </span>
                )}
              </button>
      ...
      >
        <div className="hidden md:flex gap-8">
          <button
            ...
            className="text-sm hover:text-red-500 transition-colors font-semibold"
          >
        ...
        <MobileMenu
          ...
          socialLinks={{
            ...
            email:
              "https://mail.google.com/mail/u/0/?fs=1&to=gabriellucasafb@gmail.com&su=Contato+do+Portf%C3%B3lio&body=Ol%C3%A1,+vim+pelo+seu+Portf%C3%B3lio+e+gostaria+de+falar+sobre...&tf=cm",
          }}
        />
      </nav>
      ...
      >
        ...
        <div className="text-center max-w-2xl relative z-10 animate-slide-up">
          ...
          <h1 className="text-5xl md:text-6xl font-bold mb-3 text-black dark:bg-gradient-to-r dark:text-red-700 dark:bg-clip-text dark:animate-pulse-glow">
            Gabriel Lucas
          </h1>
          ...
          <div className="flex justify-center gap-6 mb-12">
            ...
            <a
              href="https://instagram.com/gabriellucasafb"
              target="_blank"
              rel="noopener noreferrer"
              className="p-3 rounded-full border border-black/50 dark:border-red-500/50 hover:border-black dark:hover:border-red-500 bg-gradient-to-br from-black/10 to-gray-700/10 dark:from-red-500/10 dark:to-red-400/10 hover:from-black/20 hover:to-gray-800/20 dark:hover:from-red-400/20 dark:hover:to-red-400/20 text-black dark:text-red-400 hover:text-black dark:hover:text-red-500 transition-all duration-300 transform hover:scale-110 hover:shadow-lg hover:shadow-black/40 dark:hover:shadow-red-500 group"
          ...
          <section className="mb-20">
            <h2 className="text-3xl md:text-4xl font-bold mb-12 flex items-center justify-between">
              ...
              <a href="./docs/Curriculo Full-stack.pdf" download>
                <Button
                  variant="outline"
                  className="bg-transparent border-black/30 dark:border-red-500/30 hover:bg-black/10 dark:hover:bg-red-500/10 transition-colors duration-300 h-8 px-2 text-xs md:h-10 md:px-4 md:text-sm"
                >
            ...
            <div className="space-y-8">
              {experiences.map((exp, expIdx) => (
                <div
                  key={expIdx}
                  className="border-l-4 border-black dark:border-red-500 pl-6 py-4 p-6 -ml-6 rounded-r-lg bg-gradient-to-r from-black/5 to-transparent dark:from-red-500/5 dark:to-transparent hover:from-black/10 hover:to-black/5 dark:hover:from-red-500/10 dark:hover:to-red-400/5 transition-all duration-300 card-hover animate-slide-up"
                  ...
                  <ul className="space-y-3">
                    {exp.description.map((desc, descIdx) => (
                      <li
                        ...
                        style={{
                          animationDelay: `${expIdx + 0.2 + descIdx * 0.1}s`,
                        }}
                      >
                        <span className="dark:text-red-500 text-black mt-1 group-hover/item:animate-pulse">
                          •
                        </span>
                        <span>{desc}</span>
                      </li>
                ...
                {skillsData[language].categories.map(
                  (category, categoryIdx) => {
                    ...
                    return (
                      <div
                        key={categoryIdx}
                        className="p-6 rounded-lg border border-black/30 dark:border-red-500/30 bg-gradient-to-br from-black/5 to-black/10 dark:from-red-500/10 dark:to-red-500/10 hover:border-black/60 dark:hover:border-red-500/60 transition-all duration-300 hover:shadow-lg hover:shadow-black dark:hover:shadow-red-500"
                      >
          ...
          <section className="mb-20">
            ...
            <div className="space-y-10">
              {educationData[language].items.map((item, itemIdx) => (
                <div
                  key={itemIdx}
                  className="border-l-4 border-black dark:border-red-500 pl-6 py-4 p-6 -ml-6 rounded-r-lg bg-gradient-to-r from-black/5 to-transparent dark:from-red-500/5 dark:to-transparent hover:from-black/10 hover:to-black/5 dark:hover:from-red-500/10 dark:hover:to-red-400/5 transition-all duration-300 card-hover"
                >
                  <div className="mb-4">
                      ...
                      <div className="flex gap-3">
                        ...
                        {project.github !== "#" && (
                          ...
                          >
                            <Button
                              variant="outline"
                              className="px-6 py-2 dark:border-red-500/50 dark:hover:border-red-500 dark:hover:bg-red-500/10 border-black/50 hover:border-black hover:bg-black/10"
                            >
                  ...
                  return (
                    ...
                    >
                      <div className="border border-black/30 text-sm dark:border-red-500/30 rounded-lg p-6 bg-gradient-to-br from-black/5 to-black/5 dark:from-red-500/5 dark:to-red-400/5 hover:border-black dark:hover:border-red-500 hover:from-black/10 hover:to-black/10 dark:hover:from-red-500/10 dark:hover:to-red-400/10 transition-all duration-300 hover:shadow-lg hover:shadow-black/20 dark:hover:shadow-red-500/20 transform hover:scale-105 hover:-translate-y-2">
                        <div
                          className={`inline-flex p-3 rounded-lg bg-gradient-to-r ${method.color} mb-4 dark:text-red-500`}
                        >
