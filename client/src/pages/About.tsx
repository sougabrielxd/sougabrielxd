...
// ============================================================
// FUNÇÃO AUXILIAR PARA MAPEAR TECNOLOGIAS A ÍCONES
// ============================================================
...
// ============================================================
// DADOS DAS NOVAS SEÇÕES (Habilidades, Formação, Certificados)
// ============================================================
        ...
        <section className="mb-20">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-1">
              <div className="sticky top-24 p-6 rounded-lg 
                  border border-black/40 dark:border-red-500/40 
                  ...
                  {skillsData[language].studying.stacks.map((stack, stackIdx) => (
                    <span
                      ...
                      className="text-base px-4 py-2 rounded-full 
                          bg-gradient-to-r from-black/20 to-black/30 dark:from-red-500/30 dark:to-red-400/40 
                          text-white dark:text-white 
                          border border-black/50 dark:border-red-500/60 
